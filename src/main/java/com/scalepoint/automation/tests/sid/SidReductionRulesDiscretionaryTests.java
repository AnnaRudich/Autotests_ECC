...
public class SidReductionRulesDiscretionaryTests extends BaseTest {
    ...
    @Test(dataProvider = "testDataProvider", description = "ECC-3031 Verify reduction rule discretionary type after clicking Reduction rule button", enabled = false)
    public void ecc3031_3_reductionRulePolicyTypeDiscretionary(@UserCompany(CompanyCode.ALKA) User user,
        ...
        ValuationWithReduction valuationWithReduction =
                SidCalculator.calculatePriceValuationWithReduction(Constants.PRICE_2400, depreciationPercentage, claimItem.getAlkaUserReductionRule_25());
        ...
        settlementDialog
                ...
                .doAssert(sid -> {
                    ...
                    sid.assertDepreciationValueIs(claimItem.getAlkaUserReductionRule_25().doubleValue());
                })
                .cancel();
    }
    ...
    @Test(dataProvider = "testDataProvider", description = "ECC-3031 Verify rule with type of Policy indicated after clicking Reduction rule button", enabled = false)
