...
public class CategoryGroupsScalepointIdTests extends BaseTest {
    ...
    public void createNewPsCatGroupTest(@UserAttributes(company = CompanyCode.FUTURE, type = User.UserType.SCALEPOINT_ID) User user, Category category) {
